    ...
    <Layout>
      <div>
          ...
          >
            ...
            <div className="font-bold text-white md:px-5">
              <h1 className="text-7xl md:text-4xl" data-aos='slide-right'>
                Hii , I am <b className="text-yellow-500">RAKESH</b>
              </h1>
              <h1 className="text-4xl md:text-xl" data-aos='slide-left'>
                FullStack <b className="text-red-500">Developer</b> <b className="text-red-500">Freelancer</b>
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="my-20">
          ...
          <div className="md:mx-5 mx-32 shadow-2xl bg-gray-50 -mt-20 rounded-lg hover:bg-gray-800 hover:text-white">
